...
# La documentación completa (manual de usuario, manual técnico y guías de instalación) se encuentra disponible en `https://github.com/AR-Tour-UVG/AR-Tour-V2.git/Docs/`. Y el informe final del proyecto en `/docs/informe\_final.pdf`
